...
*/
function temperatureInF(num, type) {
  if (type === "C") {
    num = temperatureCtoF(num);
  }
    else if (type === "F") {
      num = num;
  }
...
console.log(temperatureInF(101, "C"));

// function temperatureInF(num) {

//   function getNumbersFromString() {
//     let tName = `${num}`;
//     return `${(tName.match(/\d+/))}`;
//   }
//   let temp = getNumbersFromString();

//   let lastChar = num.substr(num.length -1);
//   if (lastChar = "F"){
//     temp = temp;
//   } else if (lastChar = "C") {
//     temp = Math.round(temp = (temp *(9/5) + 32));
//   }
//   return `${temp}F`;
// }
// console.log(temperatureInF("50C"));
/**
...
function appleIndex(array) {
  return console.log(array.indexOf('apple'));
}
/**
...
function isItAnApple(array) {
  let array2 = array.map(({apple}) => ({apple}));
  if ( array = "apple" ) {
    // array.map("true");
  }
  else if (array != "apple") {
...
function getCarInfoByIndex(inventory, index) {
  let LN = inventory[index];
  return `This is a ${LN.car_make} ${LN.car_model}`;
}
...
function getLastCarInfo(inventory) {
  let LT = inventory;
  return `This is a ${LT.car_make} ${LT.car_model}`;
}
console.log("getLastCarInfo");
console.log(getLastCarInfo(inventory[9]));
/**
...
console.log("aftergetModelYears");
/**
